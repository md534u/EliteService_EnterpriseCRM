...
# Importar conexión a PostgreSQL desde database.py
...
def init_users_db():
    ...
    try:
        ...
        c.execute("ALTER TABLE users ADD COLUMN IF NOT EXISTS position TEXT")
        conn.commit()
...
def register_user(user: UserCreate):
    ...
    # 3. Guardar
    cursor.execute("INSERT INTO users (username, hashed_password, role, full_name, position) VALUES (%s, %s, %s, %s, %s)",
